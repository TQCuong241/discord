...
const commands = [
  ...
  new SlashCommandBuilder()
    .setName("play")
    .setDescription("Phát nhạc từ YouTube, Spotify hoặc từ khóa")
    .addStringOption(opt =>
      opt.setName("query")
        .setDescription("Từ khóa, link YouTube hoặc link Spotify")
        .setRequired(true)
    ),
...
new SlashCommandBuilder()
  ...
  // Thêm lệnh kiểm tra thông tin TFT (Tracker.gg)
    new SlashCommandBuilder()
        .setName("checktft")
        .setDescription("🔍 Xem thông tin TFT (Teamfight Tactics) của người chơi")
        .addStringOption(opt =>
        opt
            .setName("name")
            .setDescription("Tên người chơi (ví dụ: TRQ Bro)")
  ...
  // Thêm lệnh kiểm tra thông tin LoL (Tracker.gg)
    new SlashCommandBuilder()
        .setName("checklol")
        .setDescription("🔍 Xem thông tin League of Legends của người chơi")
        .addStringOption(opt =>
        opt
            .setName("name")
            .setDescription("Tên người chơi (ví dụ: TRQ Bro)")
